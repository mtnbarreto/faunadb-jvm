...
public class ObjectCodecSpec {
  ...
  public void shouldConvertObjectWithNull() {
    ...
    assertThat(obj.get("another"), CoreMatchers.<Value>is(Value.NullV.Null));
  ...
  public void shouldConvertNestedObject() {
    ...
    assertThat(obj.get("nested").asObject().get("another"), CoreMatchers.<Value>is(Value.NullV.Null));
